...
/*
	This processes the interaction stream and updates the vector of tracked users
*/
...
/*
	This is the function that acts as the condition for the loop.
	It first checks if there are any available frames in the Depth and Skeleton Streams
	and then passes those onto 
*/
